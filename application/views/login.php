...
<head>
  ...
  <!-- Title -->
  <title itemprop="name">MANAGE EXPENSES - LOGIN</title>
...
<body>
	...
	<div class="container-login100">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			...
			<!-- Login form-->
			<form action="<?php echo base_url(); ?>auth/user/login" method="post" class="login100-form validate-form">
				...
				<!-- Email / Mobile -->
				<div class="wrap-input100 validate-input m-b-20" data-validate="enter email or mobile">
					<input class="input100" type="text" name="emailormobile" id="emailormobile" placeholder="email or mobile">
				...
				<div class="container-login100-form-btn">
					<input type="submit" name="submit" id="submit" value="Sign In" class="login100-form-btn">
				</div>
				<!-- Submit -->
			...
			<div class="text-center p-t-27 p-b-150">
				<span class="txt1 cwhite">
					<a href="<?php echo base_url(); ?>auth/register"><b class="cwhite">REGISTER HERE</b></a> |
