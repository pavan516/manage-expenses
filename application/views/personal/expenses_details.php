  ...
  <tbody id="personal_table_tbody_height">
    <?php if(!empty($items)) {
      foreach($items as $item) { ?>
        ...
        <!-- Load data -->
        <tr id="expenses_<?php echo $item['uuid']; ?>" onclick="open_expenses_modal('<?php echo $item['uuid']; ?>');" class="<?php echo $color; ?>">
          <td id="expenses_date_<?php echo $item['uuid']; ?>" class="no_wrap"><?php echo \year_date_text_format($item['date']); ?></td>
          <td id="expenses_title_<?php echo $item['uuid']; ?>" class="break_all"><?php echo $item['title']; ?></td>
          <td id="expenses_value_<?php echo $item['uuid']; ?>" class="no_wrap fright"><b><?php echo currency_format($item['value']); ?> <i class="<?php echo $arrowClass; ?>" aria-hidden="true" class="<?php echo $color; ?>"></b></td>
        </tr>
        <!-- Load data -->
...
function doSearch()
{
  ...
  /** load expenses list */
  load_expenses(type, date, fdate, tdate, search, order, name, pageno, limit);
