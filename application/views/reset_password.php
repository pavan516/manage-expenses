	...
	<div class="container-login100">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			...
			<!-- Error Message -->
				...
				<!-- Reset Password form-->
				<form action="<?php echo base_url(); ?>auth/resetpassword" method="post" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-20" data-validate="enter email">
						<input name="email" id="email" value="<?php echo $email; ?>" class="display_none">
						<input class="input100" type="text" name="email" id="email" value="<?php echo $email; ?>" disabled>
					...
					<!-- OTP -->
					<div class="wrap-input100 validate-input m-b-20" data-validate="enter email">
						<input name="otp" id="otp" value="<?php echo $otp; ?>" class="display_none">
						<input class="input100" type="text" name="otp" id="otp" value="<?php echo $otp; ?>" disabled>
						<span class="focus-input100"></span>
					</div>
					<!-- OTP -->
					...
					<div class="wrap-input100 m-b-25 input-group" id="show_hide_password">
						<input class="input100" type="password" name="new_pass" id="new_pass" placeholder="password">
					...
					<!-- Repeat Password -->
					<div class="wrap-input100 m-b-25 input-group" id="show_hide_password_repeat">
						<input class="input100" type="password" name="repeat_pass" id="repeat_pass" placeholder="repeat password">
						<div class="input-group-addon bwhite password_br">
							<a href=""><i class="fa fa-eye-slash" aria-hidden="true"></i></a>
						</div>
						<span class="focus-input100"></span>
					...
					<div class="container-login100-form-btn">
						<input type="submit" name="submit" id="submit" value="Reset Password" class="login100-form-btn">
					</div>
					<!-- Submit -->
				...
				<!-- Login / reset password here -->
				<div class="text-center p-t-27 p-b-150">
					<span class="txt1" class="cwhite">
						<a href="<?php echo base_url(); ?>auth/login"><b class="cwhite">LOGIN HERE</b></a> |
						<a href="<?php echo base_url(); ?>auth/forgotpassword"><b class="cwhite">RESET PASSWORD HERE</b></a>
					</span>
				</div>
				<!-- Login / reset password here -->
